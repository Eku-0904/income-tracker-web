...
export const ListItem = ({ transaction, onDelete, handleModalOpen }: Props) => {
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ minWidth: "150px" }}>
                    ...
                    <div style={{ display: "flex", gap: "10px", marginTop: "10px" }}>
                        ...
                        <EditRecordModal transactionId={transaction._id} isEditOpen={isEditOpen} handleEditModalClose={handleEditModalClose}/>
                    </div>
                </div>
            </div>
