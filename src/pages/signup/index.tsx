...
interface SignupResponse {_id: string;}
...
const Signup = () => {
  ...
  const handleChangeRepassword = (event: React.ChangeEvent<HTMLInputElement>) => { setRepassword(event.target.value); };
        ...
        <div className="left">
          <div className="inputs">
            ...
            {loader ? (
              ...
              <div className="login" onClick={createUser}>Sign up</div>
            )}
            <div style={{ color: "red" }}>{required}</div>
            <p>Already have an account? <span className="signup-link" onClick={handleLogin}>Log in</span></p>
          </div>
        </div>
